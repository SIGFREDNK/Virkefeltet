...
function Search(_ref) {
  ...
  }, isOpen && options.filter(option => option.value.toLowerCase().includes(value.toLowerCase())).map((option, key) => /*#__PURE__*/_react.default.createElement("div", {
    key: key,
  ...
  }, option.value))), frozen && /*#__PURE__*/_react.default.createElement(_fa.FaTimes, {
